...
class DynamicModel extends Model
{
     ...
     */
    public function defineAttribute(string $name, mixed $value = null): void
    {
        $this->_attributes[$name] = $value;
    }
     ...
     * @param string|Validator|callable $validator the validator. This can be either:
     ...
     */
    public static function validateData(array $data, array $rules = []): static
    {
     ...
     */
    private function defineAttributesByValidator(Validator $validator): void
    {
     ...
     * @since 2.0.35
     */
    public function setAttributeLabel(string $attribute, string $label): static
    {
